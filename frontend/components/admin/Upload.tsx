        ...
        <section className='w-full py-6 flex flex-col'>
            <main className='w-full flex flex-col gap-7'>
                <div className='flex flex-col'>
                    <h1 className='uppercase text-color2 md:text-2xl font-bold text-xl'>Upload File</h1>
                                ...
                                >
                                    {acceptedFile ? (
                                        ...
                                        <div className="flex flex-col items-center">
                                            ...
                                            <h3 className='capitalize text-lg'>Click to upload or drag and drop</h3>
                                        </div>
                                    )}
                                </div>
                            </>
                ...
                <div className='w-full flex md:flex-row flex-col gap-3 md:gap-0 justify-between items-center lg:px-8 md:px-6'>
                    ...
                    <label className="inline-flex items-center cursor-pointer">
                        <span className="me-3 text-sm font-medium text-color2">Mentors</span>
                        <input
                            type="checkbox"
                            checked={isChecked}
                        ...
                        <span className="ms-3 text-sm font-medium text-color2 ">Students</span>
                    </label>

                    <Button type="button" className="bg-color1 text-gray-100 hover:bg-color2">Upload List</Button>
                </div>
            </main>
        </section>
    )
